<a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal{{ $product }}"><i class="far fa-eye"></i></a>
<!-- Product Quick View Modal Start -->
<div class="modal fade quick-view-product" id="quick-view-modal{{ $product }}" tabindex="-1" aria-hidden="true">
